...
Процедура ТестДолжен_ПроверитьУстановкуДанныхВПроблемуСтруктурой() Экспорт
	...
	ЭталонСтркПоля = Новый Структура();
	ЭталонСтркПоля.Вставить("summary", "Привет");
	ЭталонСтркПоля.Вставить("description", "Привет мир");
	...
	ЭталоннаяСтруктура.Вставить("fields", ЭталонСтркПоля);
