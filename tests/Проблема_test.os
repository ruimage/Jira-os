...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьУстановитьЗначенияПоля");
...
Процедура ТестДолжен_ПроверитьУстановитьЗначенияПоля()  Экспорт
	...
	Проблема.УстановитьЗначенияПоля("key" , "TEST-99");
	Проблема.УстановитьЗначенияПоля("fields.summary" , "ОбновленноеЗначениеПоля");
	
	
	Ожидаем.Что(Проблема.key).ИмеетТип("Строка").Равно("TEST-99");
	Ожидаем.Что(Проблема.fields.summary).ИмеетТип("Строка").Равно("ОбновленноеЗначениеПоля");
