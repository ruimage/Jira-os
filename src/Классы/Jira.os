...
Функция РедактироватьПроблему(АдресСистемы, КукиДоступа, КлючПроблемы, СтркНовыеЗначенияПолей) Экспорт
	
	СтрктRESTЗапроса = ПолучитьСтруктуруЗапросаRESTПоИмени("РедактироватьПроблему");
